...
<footer class="default-wp-footer">
    <div class="content">
        <div class="container">
            <div><?php echo esc_html_e("Copyright 2016 - 2017 Pixor | All Rights Reserved | Powered by","whitelabel") ?> <a href="<?php echo esc_url("http//wordpress.org") ?>"><?php echo esc_attr("WordPress")?></a></div>
        </div>
    </div>
</footer>    
<?php } 
